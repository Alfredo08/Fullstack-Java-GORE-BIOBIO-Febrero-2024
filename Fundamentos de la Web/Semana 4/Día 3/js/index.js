...
function mostrarEditarPerfil(elementoEditar){
    const modal = document.querySelector('.modal');
    const principal = document.querySelector('.principal');
    modal.classList.remove('ocultar');
    principal.classList.add('opacidad');
    const nombreUsuario = document.querySelector('#userName').innerText;
    const ciudad = document.querySelector('#ciudad').innerText;
...
function editarPerfil(event){
    ...
    const nuevoNombre = document.querySelector('#editarNombre').value;
    const nuevaCiudad = document.querySelector('#editarCiudad').value;
    const modal = document.querySelector('.modal');
    modal.classList.add('ocultar');
    const principal = document.querySelector('.principal');
    principal.classList.remove('opacidad');
    document.querySelector('#userName').innerText = nuevoNombre;
    document.querySelector('#ciudad').innerText = nuevaCiudad;
